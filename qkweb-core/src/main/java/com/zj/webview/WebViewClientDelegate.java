 ...
 */
public class WebViewClientDelegate extends BaseWebViewClient {


    private BaseWebViewClient mDelegate;
    private static final String TAG = WebViewClientDelegate.class.getSimpleName();

    WebViewClientDelegate(BaseWebViewClient client) {
        this.mDelegate = client;
    }

    protected BaseWebViewClient getDelegate() {
        return mDelegate;
    }

    void setDelegate(BaseWebViewClient delegate) {
