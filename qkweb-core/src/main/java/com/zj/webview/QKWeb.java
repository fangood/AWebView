...
public final class QKWeb {
	/**
	 * QKWeb TAG
	 */
	private static final String TAG = QKWeb.class.getSimpleName();
	/**
	 * Activity
	 */
	 ...
	 * WebChromeClient
	 */
	private BaseWebChromeClient mTargetChromeClient;
	/**
	...
	private QKWeb(AgentBuilder agentBuilder) {
	...
	public static class PreAgentWeb {
		...
		public QKWeb go(@Nullable String url) {
			if (!isReady) {
				ready();
			}
	...
	private BaseWebChromeClient getChromeClient() {
	...
	public static final class AgentBuilder {
		...
		public AgentBuilder(@NonNull Activity activity, @NonNull Fragment fragment) {
			mActivity = activity;
			mFragment = fragment;
			mTag = QKWeb.FRAGMENT_TAG;
		}

		public AgentBuilder(@NonNull Activity activity) {
			mActivity = activity;
			mTag = QKWeb.ACTIVITY_TAG;
		}
		...
		private PreAgentWeb buildAgentWeb() {
			if (mTag == QKWeb.FRAGMENT_TAG && this.mViewGroup == null) {
				throw new NullPointerException("ViewGroup is null,Please check your parameters .");
			}
			return new PreAgentWeb(HookManager.hookAgentWeb(new QKWeb(this), this));
		}
	...
	public static class CommonBuilder {
		...
		public CommonBuilder setWebChromeClient(@Nullable BaseWebChromeClient webChromeClient) {
			this.mAgentBuilder.mWebChromeClient = webChromeClient;
			return this;

		}

		public CommonBuilder setWebViewClient(@Nullable BaseWebViewClient webChromeClient) {
