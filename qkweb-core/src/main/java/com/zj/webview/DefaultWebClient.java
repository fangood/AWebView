...
public class DefaultWebClient extends MiddlewareWebClientBase {
	 ...
	 */
	private static final String ANDROID_WEBVIEWCLIENT_PATH = ClassPathConstans.ANDROID_WEBVIEWCLIENT_PATH;
	/**
	 * intent ' s scheme
	 */
	...
	public boolean shouldOverrideUrlLoading(WebView view, WebResourceRequest request) {
		...
		if (AgentWebUtils.isOverriedMethod(mWebViewClient, "shouldOverrideUrlLoading",
				ANDROID_WEBVIEWCLIENT_PATH + ".shouldOverrideUrlLoading", WebView.class, WebResourceRequest.class) && (((tag = 1) > 0) && super.shouldOverrideUrlLoading(view, request))) {
			return true;
		}
...
//        this.mWebView.setVisibility(View.GONE);
	...
	public static class Builder {
		...
		public Builder setClient(BaseWebViewClient client) {
			this.mClient = client;
			return this;
		}
