...
//            ignore.printStackTrace();
    ...
    static boolean showFileChooserCompat(Activity activity,
        ...
        try {
            ...
            Class<?> clz = Class.forName(ClassPathConstans.FILE_CHOOLSER_PATH);
...
//                LogUtils.i(TAG, Arrays.toString(clz.getDeclaredMethods()));
            ...
            if (throwable instanceof ClassNotFoundException) {
                LogUtils.e(TAG, "Please check whether compile'com.zj.webview:filechooser:x.x.x' dependency was added.");
            }
            if (valueCallbacks != null) {
