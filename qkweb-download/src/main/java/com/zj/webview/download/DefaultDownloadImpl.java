...
public class DefaultDownloadImpl implements DownloadListener {
	 ...
	 */
	private com.zj.webview.download.DownloadListener mDownloadListener;
	/**
	 * Activity
	 */
...
//                mContext.getPackageManager().resolveActivity(mIntent)
	...
	public static DefaultDownloadImpl create(@NonNull Activity activity,
	                                         ...
	                                         @Nullable com.zj.webview.download.DownloadListener downloadListener,
	                                         @NonNull com.zj.webview.download.DownloadingListener downloadingListener,
	...
	public static class ExtraServiceImpl extends AgentWebDownloader.ExtraService implements Cloneable, Serializable {
		...
		private transient com.zj.webview.download.DownloadListener mDownloadListener;
...
//        private AtomicInteger state = new AtomicInteger(PENDDING);
		...
		ExtraServiceImpl setDownloadListener(com.zj.webview.download.DownloadListener downloadListeners) {
