...
import com.zj.webview.util.HttpHelper;
import com.zj.webview.util.MarkdownProcessor;
...
public class BaseMarkdownView extends WebView{

    private static final String TAG = "MarkdownView";

    public BaseMarkdownView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public BaseMarkdownView(Context context) {
        super(context);
    }
