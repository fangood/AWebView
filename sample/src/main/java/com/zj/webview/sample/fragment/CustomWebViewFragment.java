...
import com.zj.webview.download.BaseMarkdownView;
import com.zj.webview.sample.R;


public class CustomWebViewFragment extends QKWebFragment {


    private BaseMarkdownView mMarkdownWebView;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mMarkdownWebView = new BaseMarkdownView(getActivity());
